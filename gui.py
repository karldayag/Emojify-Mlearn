...
if __name__ == '__main__':
    root=tk.Tk()
    img = ImageTk.PhotoImage(Image.open(r"C:\Users\Karl Joshua\Documents\Downloads\creative-blue-letters-uc-u-c-logo-with-leading-lines-and-road-concept-design-letters-with-geometric-design-vector.jpg"))
